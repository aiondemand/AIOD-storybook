import{f as k}from"./index-Z5tTm0QU.js";const A=({title:r,tag:o,number:x,date:d,category:l,variant:e,text:C,link:n,linkCircle:a,icon:b,label:m})=>{const s=document.createElement("div"),S=new Date(d).toLocaleDateString("pt-PT",{day:"2-digit",month:"2-digit",year:"numeric"});return e==="big-numbers"&&(s.className=["card-news card-numbers"].join(" "),s.innerHTML=`
