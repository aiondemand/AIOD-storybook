import{f as g}from"./index-Z5tTm0QU.js";const v=({image:o,title:r,imageAlt:c,list:s,link:a,icon:d,label:p})=>{const t=document.createElement("div");t.className=["product-list-developer-card  has-unordered-list"].join(" ");const u=Object.values(s).length>0?Object.values(s).map(m=>`<li>${m}</li>`).join(""):"";return t.innerHTML=`
