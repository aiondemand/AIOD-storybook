import{f as m}from"./index-Z5tTm0QU.js";const p=({image:e,title:r,imageAlt:c,content:i,link:a,icon:d,label:u})=>{const o=document.createElement("div");return o.className=["featured-products-item"].join(" "),o.innerHTML=`
