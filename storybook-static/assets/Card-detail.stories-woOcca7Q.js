import{f as b}from"./index-BDOojamX.js";const v=({image:e,title:o,imageAlt:r,number:d,list:l,text:p,link:n,icon:m,label:u})=>{const s=document.createElement("div");s.className=["product-list"].join(" ");const g=Object.values(l).length>0?Object.values(l).map(x=>`<li>${x}</li>`).join(""):"";return s.innerHTML=`
