import{f as h}from"./index-BDOojamX.js";const f=({image:e,title:a,imageAlt:o,tag:r,date:c,category:l,variant:t,text:d,link:m,icon:x,label:y})=>{const i=document.createElement("div");i.className=["card-news"].join(" ");const b=new Date(c).toLocaleDateString("pt-PT",{day:"2-digit",month:"2-digit",year:"numeric"});return i.innerHTML=`
...
}`,...(v=(w=n.parameters)==null?void 0:w.docs)==null?void 0:v.source}}};const D=["primary","news"];export{D as __namedExportsOrder,P as default,n as news,s as primary};
