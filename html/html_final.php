    ...
    <div class="footer-top">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12 offset-lg-1 col-lg-4 d-lg-flex flex-lg-column justify-content-lg-between column-show">
          ...
          <div class="col-12 offset-lg-1 col-lg-4 d-lg-flex flex-lg-column justify-content-lg-between column-hide">
